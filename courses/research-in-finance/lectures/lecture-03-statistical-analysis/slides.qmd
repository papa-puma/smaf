...
- **Deadline:** **{{< meta assignment-1-problem-set-deadline >}} (midnight)**. Email files to [oliver.padmaperuma@uni-ulm.de](mailto:oliver.padmaperuma@uni-ulm.de), with [andre.guettler@uni-ulm.de](mailto:andre.guettler@uni-ulm.de) and your teammates in CC.
...
- @angrist2009mostly — the standard graduate text on identification and causal inference in empirical economics.
- @thulin2024modern — modern statistical methods worked through in R, free at <https://www.modernstatisticswithr.com/>.
- @navarro2015learning — accessible introduction to statistics with R, free at <https://learningstatisticswithr.com/>.
- @gentle2020statistical — applied statistical analysis on financial data, with R examples.
- @james2021introduction — covers regression, model selection, resampling, and tree-based methods.
