...
> **Due:** {{< meta assignment-2-referee-report-deadline >}} via email.
> **Submission format:** one PDF, 2.5–3 pages, 11 pt Times New Roman, 1.5 spaced.
> **Group size:** up to **5** students.
> **Weight:** **{{< meta assignment-2-referee-report-weight >}}%** of the final grade.

Attend the mandatory **Brown Bag Seminar on {{< meta lecture-05-brown-bag-seminar-date >}} ({{< meta lecture-05-brown-bag-seminar-time >}})** and select **one doctoral presentation** to critique, applying the writing, publishing, and refereeing tips from Lecture 4 to practice thesis-level analysis.
